      ...
      <header>
        <nav className="nav" role="navigation" aria-label="Navigation principale">
          ...
          <nav className="nav-links" aria-label="Menu principal">
            {[["accueil","Accueil"],["formations","Formations"],["parcours","Parcours"],["forum","Communauté 💬"],["evenements","📅 Événements"],["financement","Financement"],["depot","📤 Déposer"],["profil","Mon Profil"]].map(([id,label])=>(
