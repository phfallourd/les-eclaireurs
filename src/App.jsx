...
const COURSES=[
  ...
  {id:15,source:"schneider",sourceLabel:"Schneider Electric",sourceColor:"#3db83d",
    emoji:"🎥",thumbBg:"linear-gradient(135deg,#dcfce7,#bbf7d0)",
    title:"Tuto vidéo — Installer la borne EVlink Home",
    desc:"Playlist officielle Schneider Electric : étapes pas à pas pour installer la borne de recharge résidentielle EVlink Home.",
    level:"Niv. 1",lvlBg:"var(--green-lt)",lvlColor:"var(--green)",
    duration:"~10 min",format:"Vidéo",badges:[{t:"Gratuit",c:"cb-free"}],
    themes:["IRVE"],regions:["all"],
    url:"https://www.youtube.com/watch?v=HhiCM03DDWs",
    objectives:["Déballage et fixation de la borne","Raccordement électrique","Mise en service","Vérifications de sécurité"]},
  {id:16,source:"schneider",sourceLabel:"Schneider Electric",sourceColor:"#3db83d",
    emoji:"🎥",thumbBg:"linear-gradient(135deg,#dcfce7,#bbf7d0)",
    title:"Tuto vidéo — Installer la borne EVlink Pro AC (tertiaire)",
    desc:"Playlist officielle Schneider Electric : installation de la borne EVlink Pro AC pour applications tertiaires.",
    level:"Niv. 2",lvlBg:"var(--blue-lt)",lvlColor:"var(--blue)",
    duration:"~12 min",format:"Vidéo",badges:[{t:"Gratuit",c:"cb-free"}],
    themes:["IRVE"],regions:["all"],
    url:"https://www.youtube.com/watch?v=VodE9VnBgdQ",
    objectives:["Spécificités d'une installation tertiaire","Raccordement et câblage","Configuration de la supervision","Mise en service et tests"]},
  {id:17,source:"legrand",sourceLabel:"Legrand",sourceColor:"#e2001a",
    emoji:"🎥",thumbBg:"linear-gradient(135deg,#fee2e2,#fecaca)",
    title:"Tuto vidéo — Installer la borne Green'Up Home monophasée",
    desc:"Playlist officielle Legrand \"Tutoriels Green'Up\" : installation de la borne de recharge résidentielle Green'Up Home.",
    level:"Niv. 1",lvlBg:"var(--green-lt)",lvlColor:"var(--green)",
    duration:"~8 min",format:"Vidéo",badges:[{t:"Gratuit",c:"cb-free"}],
    themes:["IRVE"],regions:["all"],
    url:"https://www.youtube.com/watch?v=-ptYJQ0fKAY",
    objectives:["Présentation du matériel Green'Up Home","Câblage monophasé","Fixation murale","Mise en service"]},
  {id:18,source:"hager",sourceLabel:"Hager",sourceColor:"#c8000a",
    emoji:"🎥",thumbBg:"linear-gradient(135deg,#ffe4e6,#fecdd3)",
    title:"Tuto vidéo — Première connexion app Hager Charge (witty one)",
    desc:"Playlist officielle Hager \"Tutoriels witty\" : appairage de l'application Hager Charge avec la borne witty one.",
    level:"Niv. 1",lvlBg:"var(--green-lt)",lvlColor:"var(--green)",
    duration:"~6 min",format:"Vidéo",badges:[{t:"Gratuit",c:"cb-free"}],
    themes:["IRVE"],regions:["all"],
    url:"https://www.youtube.com/watch?v=gWjvhjQBnTs",
    objectives:["Téléchargement et installation de l'app","Appairage avec la borne witty one","Paramètres de base","Suivi de la recharge"]},
